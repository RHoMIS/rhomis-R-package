...
indicator_list <- add_indicator(
    ...
    file = "processed_data/processed_data.csv",
...
indicator_list <- add_indicator(
    ...
    file = "indicator_data/indicator_data.csv",
...
indicator_list <- add_indicator(
    ...
    file = "processed_data/processed_data.csv, crop_data/crop_harvest_kg_per_year.csv",
...
indicator_list <- add_indicator(
    ...
    file = "processed_data/processed_data.csv, crop_data/crop_consumed_kg_per_year",
...
indicator_list <- add_indicator(
    ...
    file = "processed_data/processed_data.csv, crop_data/crop_sold_kg_per_year",
...
indicator_list <- add_indicator(
    ...
    file = "processed_data/processed_data.csv, crop_data/crop_income_per_year.csv",
    description="The income in local currency units per year from selling a specific crop. We convert the <code>crop_sold_price_quantityunits</code> to a numeric conversion factor (e.g. <code>price_per_sack_50kg</code> would convert to <code>50</code>. We take the <code>crop_sold_kg_per_year</code> and multiple it by this conversion factor to get the annual income. Please not there is one common exceptions, when the unit is  <code>total_income_per_year<code> we simply take the value from <code>crop_sold_income</code>",
    output_format="loop", #column, loop, #table
    individual_columns_required=list(),
...
indicator_list <- add_indicator(
    ...
    file = "processed_data/processed_data.csv, crop_data/crop_price.csv",
    description="The price of a crop in local currency units per kg. If the unit <code>crop_sold_price_quantityunits</code> was a mass unit (e.g. <code>price_per_sack_50kg</code>) then the price is derived from this. If the unit was <code>total_income_per_year<code>, then the price is calculated by dividing the <code>crop_income_per_year</code> by <code>crop_sold_kg_per_year</code>",
    output_format="loop", #column, loop, #table
    individual_columns_required=list(),
    loop_columns_required=list(),
    conversion_tables_required=list(),
...
indicator_list <- add_gendered_indicator(
    indicator_list,
    indicator_name = "crop_consumed_kg_per_year",
    file = "processed_data/processed_data.csv, extra_outputs/gender_control/",
...
indicator_list <- add_indicator(
    ...
    file = "processed_data/processed_data.csv, livestock_data/livestock_price_per_animal.csv",
...
indicator_list <- add_indicator(
    ...
    file = "processed_data/processed_data.csv, livestock_data/meat_kg_per_year.csv",
...
indicator_list <- add_indicator(
    ...
    file = "processed_data/processed_data.csv, livestock_data/meat_sold_kg_per_year.csv",
...
indicator_list <- add_indicator(
    ...
    file = "processed_data/processed_data.csv, livestock_data/meat_consumed_kg_per_year.csv",
...
indicator_list <- add_indicator(
    ...
    file = "processed_data/processed_data.csv, livestock_data/meat_price_per_kg.csv",
...
indicator_list <- add_indicator(
    ...
    file = "processed_data/processed_data.csv, livestock_data/milk_collected_litres_per_year.csv",
...
indicator_list <- add_indicator(
    ...
    file = "processed_data/processed_data.csv, livestock_data/milk_sold_litres_per_year.csv",
...
indicator_list <- add_indicator(
    ...
    file = "processed_data/processed_data.csv, livestock_data/milk_consumed_litres_per_year.csv",
...
indicator_list <- add_indicator(
    ...
    file = "processed_data/processed_data.csv, livestock_data/milk_sold_income.csv",
...
indicator_list <- add_indicator(
    ...
    file = "processed_data/processed_data.csv, livestock_data/eggs_collected_kg_per_year.csv",
...
indicator_list <- add_indicator(
    ...
    file = "processed_data/processed_data.csv, livestock_data/eggs_sold_kg_per_year.csv",
...
indicator_list <- add_indicator(
    ...
    file = "processed_data/processed_data.csv, livestock_data/eggs_consumed_kg_per_year.csv",
...
indicator_list <- add_indicator(
    ...
    file = "processed_data/processed_data.csv, livestock_data/eggs_income_per_year.csv",
...
indicator_list <- add_indicator(
    ...
    file = "processed_data/processed_data.csv, livestock_data/eggs_price_per_kg.csv",
...
indicator_list <- add_indicator(
    ...
    file = "processed_data/processed_data.csv, livestock_data/bees_honey_kg_per_year.csv",
...
indicator_list <- add_indicator(
    ...
    file = "processed_data/processed_data.csv, livestock_data/bees_honey_sold_kg_per_year.csv",
...
indicator_list <- add_indicator(
    ...
    file = "processed_data/processed_data.csv, livestock_data/bees_honey_consumed_kg_per_year.csv",
...
indicator_list <- add_indicator(
    ...
    file = "processed_data/processed_data.csv, livestock_data/bees_honey_price_per_kg.csv",
...
indicator_list <- add_indicator(
    indicator_list,
    indicator_name = "livestock_sold",
    file = "processed_data/processed_data.csv, livestock_data/livestock_sold.csv",
    description="The number of livestock sold, asked directly to respondents",
    output_format="loop", #column, loop, #table
    individual_columns_required=list(),
    loop_columns_required=list(""),
    conversion_tables_required=list(),
...
indicator_list <- add_indicator(
    ...
    file = "processed_data/processed_data.csv, livestock_data/livestock_sale_income.csv",
    description="The income from whole livestock being sold, asked directly to respondents",
    output_format="loop", #column, loop, #table
    individual_columns_required=list(),
    loop_columns_required=list(""),
    conversion_tables_required=list(),
...
indicator_list <- add_indicator(
    ...
    file = "processed_data/processed_data.csv, extra_outputs/consumption_lcu_values/consumption_lcu_values_value_crop_consumed_lcu.csv",
    description="The value of crops which were consumed annually in local currency units. This is calculated using the average prices of each crop within a given project. Average prices are verified by people working on the project",
    output_format="loop", #column, loop, #table
    individual_columns_required=list(),
...
indicator_list <- add_gendered_indicator(
    ...
    indicator_name = "value_crop_consumed_lcu",
    file = "processed_data/processed_data.csv, extra_outputs/gender_control",
    description="The value of crops which were consumed annually in local currency units, broken down for each gender. This is calculated using the average prices of each crop within a given project. Average prices are verified by people working on the project",
    output_format="loop", #column, loop, #table
    individual_columns_required=list(),
    loop_columns_required=list("crop_consume_control"),
    conversion_tables_required=list(),
...
indicator_list <- add_indicator(
    ...
    file = "processed_data/processed_data.csv, extra_outputs/consumption_lcu_values/consumption_lcu_values_value_meat_consumed_lcu.csv",
    description="The value of meat which was consumed annually in local currency units. This is calculated using the average prices of meat from each animal within a given project. Average prices are verified by people working on the project",
    output_format="loop", #column, loop, #table
    individual_columns_required=list(),
...
indicator_list <- add_gendered_indicator(
    ...
    indicator_name = "value_meat_consumed_lcu",
    file = "processed_data/processed_data.csv, extra_outputs/gender_control",
    description="The value of meat which was consumed annually in local currency units, broken down by gender category. This is calculated using the average prices of meat from each animal within a given project. Average prices are verified by people working on the project",
    output_format="loop", #column, loop, #table
    individual_columns_required=list(),
    loop_columns_required=list("livestock_meat_who_control_eating"),
    conversion_tables_required=list(),
...
indicator_list <- add_indicator(
    ...
    file = "processed_data/processed_data.csv, extra_outputs/consumption_lcu_values/consumption_lcu_values_value_eggs_consumed_lcu.csv",
    description="The value of eggs which were consumed annually in local currency units. This is calculated using the average prices of eggs from each animal within a given project. Average prices are verified by people working on the project",
    output_format="loop", #column, loop, #table
    individual_columns_required=list(),
    loop_columns_required=list("livestock_name"),
...
indicator_list <- add_gendered_indicator(
    ...
    indicator_name = "value_eggs_consumed_lcu",
    file = "processed_data/processed_data.csv, extra_outputs/gender_control",
    description="The value of eggs which were consumed annually in local currency units, broken down by gender category. This is calculated using the average prices of eggs from each animal within a given project. Average prices are verified by people working on the project",
    output_format="loop", #column, loop, #table
    individual_columns_required=list(),
    loop_columns_required=list("eggs_who_control_eating"),
    conversion_tables_required=list(),
...
indicator_list <- add_indicator(
    ...
    file = "processed_data/processed_data.csv, extra_outputs/consumption_lcu_values/consumption_lcu_values_value_milk_consumed_lcu.csv",
    description="The value of milk which was consumed annually in local currency units. This is calculated using the average prices of milk from each animal within a given project. Average prices are verified by people working on the project",
    output_format="loop", #column, loop, #table
    individual_columns_required=list(),
    loop_columns_required=list("livestock_name"),
...
indicator_list <- add_gendered_indicator(
    ...
    indicator_name = "value_milk_consumed_lcu",
    file = "processed_data/processed_data.csv, extra_outputs/gender_control",
    description="The value of milk which were consumed annually in local currency units, broken down by gender category. This is calculated using the average prices of milk from each animal within a given project. Average prices are verified by people working on the project",
    output_format="loop", #column, loop, #table
    individual_columns_required=list(),
    loop_columns_required=list("milk_who_control_eating"),
    conversion_tables_required=list(),
...
indicator_list <- add_indicator(
    ...
    file = "processed_data/processed_data.csv, extra_outputs/consumption_lcu_values/consumption_lcu_values_value_honey_consumed_lcu.csv",
    description="The value of milk which was consumed annually in local currency units. This is calculated using the average prices of honey within a given project. Average prices are verified by people working on the project",
    output_format="loop", #column, loop, #table
    individual_columns_required=list(),
    loop_columns_required=list("livestock_name"),
...
indicator_list <- add_gendered_indicator(
    ...
    indicator_name = "value_bees_honey_consumed_lcu",
    file = "processed_data/processed_data.csv, extra_outputs/gender_control",
    description="The value of honey which was consumed annually in local currency units, broken down by gender category. This is calculated using the average prices of honey within a given project. Average prices are verified by people working on the project",
    output_format="loop", #column, loop, #table
    individual_columns_required=list(),
    loop_columns_required=list("bees_who_control_eating"),
    conversion_tables_required=list(),
...
indicator_list <- add_indicator(
    ...
    file="indicator_data/indicator_data.csv",
    description="The total value of all crops which were consumed over the past year (local currency units)",
    output_format="column", #column, loop, #table
    individual_columns_required=list(),
    loop_columns_required=list(),
    conversion_tables_required=list(),
...
indicator_list <- add_indicator(
    ...
    file="indicator_data/indicator_data.csv",
    description="The total value of all livestock products which were consumed over the past year (local currency units)",
    output_format="column", #column, loop, #table
    individual_columns_required=list(),
    loop_columns_required=list(),
    conversion_tables_required=list(),
...
indicator_list <- add_indicator(
    ...
    file="indicator_data/indicator_data.csv",
    description="The total value of all crops and livestock products which were consumed over the past year (local currency units)",
    output_format="column", #column, loop, #table
    individual_columns_required=list(),
    loop_columns_required=list(),
    conversion_tables_required=list(),
...
indicator_list <- add_indicator(
    ...
    file="processed_data/processed_data.csv, extra_outputs/consumption_calorie_values/consumption_calorie_values_crop_calories_consumed_kcal.csv",
...
indicator_list <- add_indicator(
    ...
    file="processed_data/processed_data.csv, extra_outputs/consumption_calorie_values/consumption_calorie_values_meat_calories_consumed_kcal.csv",
...
indicator_list <- add_indicator(
    ...
    file="processed_data/processed_data.csv, extra_outputs/consumption_calorie_values/consumption_calorie_values_eggs_calories_consumed_kcal.csv",
...
indicator_list <- add_indicator(
    ...
    file="processed_data/processed_data.csv, extra_outputs/consumption_calorie_values/consumption_calorie_values_milk_calories_consumed_kcal.csv",
...
indicator_list <- add_indicator(
    ...
    file="processed_data/processed_data.csv, extra_outputs/consumption_calorie_values/consumption_calorie_values_bees_honey_calories_consumed_kcal.csv",
...
for (gender in gender_prefixes){
    ...
    indicator_list <- add_indicator(
        ...
        file = "extra_outputs_gender_control/",
