...
#'
#' @examples
value_or_calorie_calculations_item_consumed <- function(
        data,
        name_column,
...
value_calculations <- function(processed_data,
    ...
    if ("mean_crop_price_lcu_per_kg" %in% names(prices)){
        ...
        missing_columns <- check_columns_in_data(processed_data,loop_columns = c("value_crop_consumed_lcu",
    ...
    if ("mean_meat_price_per_kg" %in% names(prices)){
        ...
        missing_columns <- check_columns_in_data(processed_data,loop_columns = c("value_meat_consumed_lcu",
    ...
    if ("mean_eggs_price_per_kg" %in% names(prices)){
        ...
        missing_columns <- check_columns_in_data(processed_data,loop_columns = c("value_eggs_consumed_lcu",
    ...
    if ("mean_milk_price_per_litre" %in% names(prices)){
        ...
        missing_columns <- check_columns_in_data(processed_data,loop_columns = c("value_milk_consumed_lcu",
        ...
        extra_outputs$value_milk_consumed_lcu <- map_to_wide_format(data = processed_data,name_column = "livestock_name", column_prefixes = "value_milk_consumed_lcu",
                                                                    types = "num")[[1]]
    ...
    if ("mean_bees_honey_price_per_kg" %in% names(prices)){
        ...
        missing_columns <- check_columns_in_data(processed_data,loop_columns = c("value_bees_honey_consumed_lcu",
